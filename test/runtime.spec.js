import fs from 'fs';
import reportGen from 'mochawesome-report-generator';
import MochawesomeRuntime from '../dist/runtime';
...
import mockSuite from './mock/mockSuite.json';
import mockResult from './mock/mockResult.json';
import mocktest from './mock/mockTest.json';
import mockStep from './mock/mockStep.json';
...
describe('MochawesomeRuntime', () => {
  ...
  describe('populateSteps', () => {
    test('Call function with parameters', () => {
      const result = runtime.populateSteps(
        mocktest.testDescribe,
        mockResult.success,
        mockStep.basicStep
      );
